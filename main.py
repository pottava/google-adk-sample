...
from google.adk.agents import LiveRequestQueue, SequentialAgent, ParallelAgent, LlmAgent
...
# from vertex_ai_search_agent.agent import root_agent as vertex_ai_search_agent
...
# search_concurrently = ParallelAgent(
...
#     name="Synthesizer",
#     instruction="Combine results from state keys 'google_search_result' and 'vertex_ai_search_result'.",
# )
# workflow = SequentialAgent(name="FetchAndSynthesize", sub_agents=[search_concurrently, synthesizer])
